...
CmdQuestion::CmdQuestion(int commandID, int pointsCount, QObject* parent):
    Command(DRAKON::IconType(commandID), pointsCount, parent),
    mOperation(Equal),
...
bool CmdQuestion::canBeCopied() const
{
    return false;
}
